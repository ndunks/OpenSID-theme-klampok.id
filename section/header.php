...
<head>
    ...
    <?php else: ?>
        ...
        <meta property="og:image" content="<?= THEME_URL ?>/img/logo.png"/>
    ...
    <?php endif; ?>
    <link rel="icon" href="<?= THEME_URL ?>/img/logo-32x32.png" sizes="32x32" />
    <link rel="icon" href="<?= THEME_URL ?>/img/logo-192x192.png" sizes="192x192" />
    <link rel="apple-touch-icon-precomposed" href="<?= THEME_URL ?>/img/logo-180x180.png" />
    <meta name="msapplication-TileImage" content="<?= THEME_URL ?>/img/logo.png" />
    ...
    <link type='text/css' href="<?= THEME_URL . '/css/style-v1.css'?>" rel='Stylesheet' />
